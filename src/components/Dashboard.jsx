...
export default function Dashboard() {
  return (
    <>
      <div className="dash">
        <Grid container className="pt-2 px-3">
          <Grid item xs={12} md={4} className="gride">
            <Card className="card">
          ...
          <Grid item xs={12} md={8} className="gride md-mt-2">
        ...
        <Grid container className="pt-2 px-3">
          <Grid item xs={12} md={4} className="mt-2 gride">
            <Card className="card">
              <Card.Title className="grid-title rounded-top-4 fs-5 px-3 py-3">
                Financial Overview
              </Card.Title>
